...
## 11. 개발하며 느낀점
아이디어나 기획자체에서는 해보고 싶은 것이 정말 많고 여러 기능을 구현하고 싶었는데 막상 주제에 가장 기초적인 이미지를 그려주게 하는 것 부터 구현하는데 무척 애를 먹었다. 요즘은 인공지능이 발달하여 chatGPT라는 실시간으로 정보를 얻을 수 있는 AI가 존재하기에 적극 활용하였지만 이것이 없었다면 내가 과연 이걸 완성할 수 있었을까?? 라는 생각을 정말 많이했다. 이번 계기로 나의 부족함을 한번 더 상기시키는 경험이 되었고 내가 가고자 하는 목표에 가까워 질 수 있도록 더욱 지식을 공부하고 역량을 늘려나가겠다 다짐했다. 또한 시간이 있었다면 처음 기획할 때 요구사항으로 계획했던 걸 모두 완성하고 싶다.