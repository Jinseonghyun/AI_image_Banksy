...
## 11. 개발하며 느낀점
아이디어나 기획자체에서는 해보고 싶은 것이 정말 많고 여러 기능을 구현하고 싶었는데 막상 주제에 가장 기초적인 이미지를 그려주게 하는 것 부터 구현하는데 무척 애를 먹었다. 이번 계기로 나의 부족함을 한번 더 상기시키는 경험이 되었고 내가 가고자 하는 목표에 가까워 질 수 있도록 더욱 지식을 공부하고 역량을 늘려나가겠다 다짐했다. 또한 시간이 있었다면 처음 기획할 때 요구사항으로 계획했던 걸 모두 완성하고 싶다.